...
def min_euclid_func(pos):
    """ takes in a list of functions and pos coordinates and returns result of minimum function """
    x, y = pos.swapaxes(0, 1)
    min_list = [min(j, k) for j, k in zip(fe(x, y), fx(x, y))]
    return min_list
...
pso_1 = PSO(particles.copy(), velocities.copy(), min_euclid_func,
            w=0.5, c_1=2.0, c_2=2.0, auto_coef=False)
