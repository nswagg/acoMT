...
# Test 2: f = lambda x, y: np.cos(3*x) * y + np.sin(1.5*y) * x
...
pso_1 = PSO(particles.copy(), velocities.copy(), fitness_function, w=0.5, c_1=2.0, c_2=2.0, auto_coef=True)
pso_2 = PSO(particles.copy(), velocities.copy(), fitness_function, w=0.5, c_1=0.0, c_2=4.0, auto_coef=False)
pso_3 = PSO(particles.copy(), velocities.copy(), fitness_function, w=0.5, c_1=4.0, c_2=0.0, auto_coef=False)
